    ...
    <div className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50">
      <div className="h-full flex items-center justify-between px-4">
        <div className="flex items-center flex-1">
          <h1 className="text-xl font-bold gradient-text">User Dashboard</h1>
          <nav className="ml-8">
            <ul className="flex space-x-6">
              ...
              <li>
                <Link to="/user/orders" className="text-gray-600 hover:text-primary">
                  Orders
                </Link>
              </li>
              <li>
                <Link to="/user/settings" className="text-gray-600 hover:text-primary">
                  Settings
                </Link>
              </li>
            </ul>
